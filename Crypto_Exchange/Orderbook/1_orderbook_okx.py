#!/usr/bin/env python3
"""OKX Order Book Feed for CLOB Aggregator"""
...
class OKXOrderBook:
    ...
    def start(self):
        ...
        self.running = True
        Thread(target=self._run, daemon=True, name="okx").start()
        ...
        while self.running:
            try:
                ...
                while self.running:
                    ...
                    if bids and asks:
                        self.aggregator.update_exchange('okx', bids, asks)
