#!/usr/bin/env python3
"""Gate.io Order Book Feed for CLOB Aggregator"""
...
class GateOrderBook:
    """Gate.io WebSocket order book feed"""
    ...
    def start(self):
        ...
        self.running = True
        Thread(target=self._run, daemon=True, name="gate").start()
        ...
        while self.running:
            try:
                ...
                while self.running:
                    ...
                    if bids and asks:
                        self.aggregator.update_exchange('gate', bids, asks)
