...
if __name__ == '__main__':
    ...
    place_market_order(api_key, secret_key, contract_name=CONTRACT_NAME, volume=VOLUME, side=SIDE, open_position=OPEN_POSITION, position_type=POSITION_TYPE, recv_window=RECV_WINDOW)
