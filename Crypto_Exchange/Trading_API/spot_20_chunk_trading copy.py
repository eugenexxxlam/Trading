...
TOTAL_VOLUME = 1  # Total amount to buy/sell
...
if __name__ == '__main__':
    ...
    for i in range(ORDER_COUNT):
        ...
        place_spot_market_order(api_key, secret_key, symbol=SYMBOL, volume=per_order_volume, side=SIDE, order_type=ORDER_TYPE)
