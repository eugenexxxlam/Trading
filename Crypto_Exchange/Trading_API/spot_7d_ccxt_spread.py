...
def calculate_percentage_difference(gaiaex_spread, exchange_spread):
    if gaiaex_spread != 'N/A' and exchange_spread != 'N/A' and gaiaex_spread != 0:
        return round(((exchange_spread - gaiaex_spread) / gaiaex_spread) * 100, 2)
    return 'N/A'
...
if __name__ == '__main__':
    ...
    for symbol in pairs_dict.keys():
        ...
        # Calculate percentage difference for spreads
        pairs_dict[symbol]['Binance Spread %'] = calculate_percentage_difference(spread, binance_spread)
        pairs_dict[symbol]['OKX Spread %'] = calculate_percentage_difference(spread, okx_spread)
        pairs_dict[symbol]['Bybit Spread %'] = calculate_percentage_difference(spread, bybit_spread)
    ...
    table = PrettyTable()
    table.field_names = ["Symbol", "Base Asset", "Quote Asset", "Price Precision", "Quantity Precision", "Spread", "Standard Symbol", "Binance Spread", "OKX Spread", "Bybit Spread", "Binance Spread %", "OKX Spread %", "Bybit Spread %"]
    ...
    for symbol, details in sorted_pairs.items():
        table.add_row([
            ...
            details['Base Asset'], 
            details['Quote Asset'], 
            details['Price Precision'], 
            details['Quantity Precision'], 
            ...
            details['Binance Spread %'], 
            details['OKX Spread %'], 
            details['Bybit Spread %']
        ])
